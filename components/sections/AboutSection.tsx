...
const PARAGRAPHS_VI = [
  ...
  <>Phòng thí nghiệm chuyên ngành xây dựng trực thuộc Trung tâm chúng tôi đã được Bộ Xây Dựng cấp mã số phòng thí nghiệm LAS-XD 449 lần đầu theo Quyết định số: 1057/QĐ – BXD ngày 15/7/2006 và được đánh giá công nhận lại theo giấy chứng nhận đủ điều kiện hoạt động thí nghiệm chuyên ngành xây dựng số: 245/GCN-BXD ngày 23/8/2022 của Bộ Xây dựng. Bên cạnh đó Phòng thí nghiệm chuyên ngành xây dựng của Trung tâm đã xây dựng, áp dụng và được chứng nhận hệ thống quản lý phòng thí nghiệm theo các yêu cầu của tiêu chuẩn TCVN ISO/IEC 17025 : 2017.</>,
